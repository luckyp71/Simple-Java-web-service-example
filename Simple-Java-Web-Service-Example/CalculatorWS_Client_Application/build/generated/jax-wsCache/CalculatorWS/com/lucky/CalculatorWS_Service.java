 ...
 * 
 */
@WebServiceClient(name = "CalculatorWS", targetNamespace = "http://lucky.com/", wsdlLocation = "http://localhost:8080/CalculatorWS/CalculatorWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORWS_QNAME = new QName("http://lucky.com/", "CalculatorWS");
    ...
    public CalculatorWS getCalculatorWSPort() {
        return super.getPort(new QName("http://lucky.com/", "CalculatorWSPort"), CalculatorWS.class);
    }
    ...
    public CalculatorWS getCalculatorWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://lucky.com/", "CalculatorWSPort"), CalculatorWS.class, features);
    }
